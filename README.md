...
it hashes and it rehashes the passwords repeatedly numerous time

1. What does bcrypt do to slow down attackers?

bcrypt is written in pure Javascript to it is slower which would result in the reduction of the number of iterations that can be processed
